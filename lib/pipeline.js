(function(root,factory){
  ...
  function normalizeFundamentals(raw={},stock={}){
    ...
    return {symbol:stock.s||stock.symbol||raw.symbol||null,name:raw.name||stock.n||null,annual,source:raw.source||'fundamentals-adapter',status:raw.status||'ok',warning:raw.warning||null,providerCode:raw.providerCode||null,asOf:annual.at(-1)?.accepted||annual.at(-1)?.filed||annual.at(-1)?.publishedDate||annual.at(-1)?.date||null};
  }
